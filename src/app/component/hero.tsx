    ...
    return (
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            When Im not coding, youll find me exploring the latest trends in web design, contributing to open-source projects, or experimenting with new technologies to stay ahead of the curve. My goal is to continue growing as a developer while making a meaningful impact on the digital world.
